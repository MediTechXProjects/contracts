...
import {IMEXToken} from "./IMEXToken.sol";
import {AccessRestriction} from "../accessRistriction/AccessRestriction.sol";

/**
 * @title MEXToken Base Contract
 * @notice MEXToken is an OFT-compliant ERC20 token with permit and burn functionality, and role-based access control.
 ...
 */
contract MEXToken is OFT, ERC20Burnable, ERC20Permit, IMEXToken {
    ...
    constructor(
        ...
        OFT("MediTechX", "MEX", _lzEndpoint, _owner)
        Ownable(_owner)
